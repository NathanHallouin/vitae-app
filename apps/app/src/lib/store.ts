...
const mmkv = createMMKV({ id: 'vitae' });
...
/**
 * En natif, le profil est lisible dès le premier rendu.
 *
 * Rien n'est pré-rendu ailleurs et MMKV lit de façon synchrone : `ProfileProvider` peut donc
 * remplir son état initial plutôt que de le corriger dans un effet. C'est la différence qui fait
 * que l'application s'ouvre sur les chiffres et le site sur un instant vide.
 */
export const LECTURE_IMMEDIATE = true;
