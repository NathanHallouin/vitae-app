...
import { webProfileStore } from '@/lib/profile-store';
...
export default function ProfileProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    // Branché ici, dans un effet : `localStorage` n'existe pas pendant le rendu serveur, et l'état
    // initial doit rester le même des deux côtés sous peine d'erreur d'hydratation.
    setProfileStore(webProfileStore);
