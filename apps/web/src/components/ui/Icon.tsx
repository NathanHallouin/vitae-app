 ...
 *
 * Les noms viennent de `@vitae/core/icons`, partagés avec l'application native : annoter `PATHS`
 * avec `Record<IconName, ReactNode>` fait échouer la compilation si l'un des deux jeux oublie une
 * icône que le métier désigne.
 */
